...
async def start(client, message):
    ...
    if len(message.command) != 2:
        ...
        await asyncio.sleep(0.4)
        await m.delete()        
        m=await message.reply_sticker("CAACAgQAAxkBAAIgaWaBHvAE6a3gfP5DVkQvNhPFUXe7AAJZHwACI9MgUGEdAAGqibr8OTQE") 
    ...
    if AUTH_CHANNEL and not await is_req_subscribed(client, message):
        ...
        await client.send_message(
            ...
            text= """⚠️ Join our updated channel below.  bot will not give you movie until you join from our update channel...
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [
                                InlineKeyboardButton('📌 ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ 📌', url=f'https://t.me/Moviesupdate34') #Don't change anything without contacting me @LazyDeveloperr
                            ]
                        ]
                    )
                )
...
async def settutorial(bot, message):
    ...
    if len(message.command) == 1:
        ...
        return await message.reply("<b>ʏᴏᴜ ᴇɴᴛᴇʀᴇᴅ ɪɴᴄᴏʀʀᴇᴄᴛ ꜰᴏʀᴍᴀᴛ !\nᴄᴏʀʀᴇᴄᴛ ꜰᴏʀᴍᴀᴛ : /set_tutorial <code>https://t.me/Backup625</code></b>")
