...
PICS = (environ.get('PICS', 'https://telegra.ph/file/744732cf25a9a29988c6e.jpg')).split() #SAMPLE PIC
...
STREAM_SITE = (environ.get('STREAM_SITE', 'yorurl.com'))
STREAM_API = (environ.get('STREAM_API', '7c05e31feed1f58fe00066964d777b4a286a9a22'))
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002216002151') # request channel id ( make sure bot is admin )
