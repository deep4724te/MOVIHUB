...
support_chat_id = environ.get('SUPPORT_CHAT_ID', 'Ownersupport') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', 'Ownersupport') # request channel id ( make sure bot is admin )
