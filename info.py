...
support_chat_id = environ.get('SUPPORT_CHAT_ID', 'https://t.me/Ownersupport') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', 'https://t.me/+sr8h-1hw2wYwNWM1') # request channel id ( make sure bot is admin )
